...
int main()
{
    ...
    for(int k=0; k<20; k++)
    {
        for(int i=0; i<=16; i++)
        {
            ...
            {
                mul_result = mul_result * num_container[i][j];
                if (j == end)
    ...
    //LAS DOS DIRECCIONES DIAGONALES
    int current_row = 0;
    ...
    //COMPARACION PARA HALLAR EL PRODUCTO MAS GRANDE EMPIEZA AQUI
    ...
    cout<<"El producto mas grande de los 4 numeros adyacentes es: "<<the_big_one<<endl;
